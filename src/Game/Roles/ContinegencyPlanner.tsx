...
import { StoreEventAction } from "./Actions/StoreEventAction";
import { TreatDiseaseAction } from "./Actions/TreatDiseaseAction";
import { UseEventAction } from "./Actions/UseEventAction";

export class ContinegencyPlanner implements IRole {
  public name: string = "Continegency Planner";
