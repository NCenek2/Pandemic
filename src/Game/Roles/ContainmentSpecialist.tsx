...
export class ContainmentSpecialist implements IRole {
  ...
  private containmentSpecialistTurnState: ContainmentSpecialistTurnState =
    new ContainmentSpecialistTurnState();
  ...
  onUndo(gameState: IGameState): void {
    this.containmentSpecialistTurnState.OnUndo(gameState);
  }
}
