...
export class Generalist implements IRole {
  public name: RoleName = "Generalist";
  private readonly _actions: MapperType;

  public actionCount: number = GENERALIST_ACTIONS_PER_TURN;
